...
import { buildBoardPlannerPreviewSnapshot } from "../src/application/planner/buildBoardPlannerPreviewSnapshot.js";
      ...
      emitters: [
        {
          ...
          yMm: 50,
          ledType: "lm301h_cri80_5000k",
          drive: { driveMode: "constantCurrent", voltageV: 2.7, currentA: 0.065, temperatureC: 25, seriesCount: 1, parallelCount: 1 },
        },
      ],
    },
  });
