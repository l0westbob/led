...
type LedBinMetadata = {
  ...
  ppfBinCode?: string;
  ppfRangeUmolS?: { minPpfUmolS: number; maxPpfUmolS: number };
};

export const LED_BIN_CATALOG: Record<string, LedBinMetadata> = {
  ...
  lm301h_evo_3000k: {
    ppfBinCode: "PV",
    ppfRangeUmolS: { minPpfUmolS: 0.494, maxPpfUmolS: 0.557 },
  },
  lm301h_evo_4000k: {
    ppfBinCode: "PT",
    ppfRangeUmolS: { minPpfUmolS: 0.507, maxPpfUmolS: 0.572 },
  },
  lm301h_evo_5000k: {
    ppfBinCode: "PR",
    ppfRangeUmolS: { minPpfUmolS: 0.52, maxPpfUmolS: 0.587 },
  },
  lm301h_evo_6500k: {
    ppfBinCode: "PP",
    ppfRangeUmolS: { minPpfUmolS: 0.52, maxPpfUmolS: 0.587 },
  ...
  lm301h_evo_mint_mb: {
    ppfBinCode: "PM",
    ppfRangeUmolS: { minPpfUmolS: 0.528, maxPpfUmolS: 0.595 },
  },
};
 ...
 * @param {string} ledId
 */
export function resolveLedBins(ledId: string): LedBinMetadata {
