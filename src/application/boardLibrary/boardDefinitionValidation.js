/**
 * @typedef {{ code:string, message:string, severity:"warning"|"error", field?:string }} BoardDefinitionIssue
 */
 ...
 */
export function validateBoardDefinitionDraft(boardDefinition) {
  const issues = [];
